...
#	author:		"Twister"
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
const SplitterRoot = preload("res://addons/script_spliter/core/ui/splitter/splitter_root.gd")
const HandlerContainer = preload("res://addons/script_spliter/core/base/container.gd")
const BaseContainerItem = preload("splitter_item.gd")

const SplitterEditorContainer = preload("res://addons/script_spliter/core/ui/splitter/splitter_editor_container.gd")

const Overlay = preload("res://addons/script_spliter/core/ui/splitter/taby/overlay.gd")
const CODE_NAME_TWISTER = preload("res://addons/script_spliter/assets/github_CodeNameTwister.png")
...
func initialize(container : TabContainer, handler_container : HandlerContainer) -> void:
	...
	_root = self
	#_root_container = BaseContainerItem.new()
	...
	base.max_columns = 1
	_root_container = base #create_base_container_item(base)
	...
	add_child(_overlay)
	#_root_container.size_flags_horizont888l = Control.SIZE_EXPAND_FILL
	#_root_container.size_flags_vertical = Control.SIZE_EXPAND_FILL
	#_root.max_columns = 1
